pipeline {
    ...
    environment {
        ...
        APP_REPO_NAME = "fthyldz-repo/fth-todo-app"
        APP_NAME = "todo"
    ...
    stages {
        ...
        stage('Deploy the App') {
            steps {
                ...
                ansiblePlaybook credentialsId: 'fatih-windows', disableHostKeyChecking: true, installation: 'ansible', inventory: 'inventory_aws_ec2.yml', playbook: 'docker_project.yml'
             }
        }
